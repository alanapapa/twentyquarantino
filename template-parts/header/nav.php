...
$menu_class = \TwentyQuarantino_Theme\Inc\Menus::get_instance();
$header_menu_id = $menu_class->get_menu_id('twentyquarantino-header-menu');
...
wp_nav_menu(
  [
    'theme_location' => 'twentyquarantino-header-menu',
